    ...
    <footer className="border-t border-gray-600 py-6 bg-black/20 mt-auto">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-600 pt-4 text-center">
          <p className="text-sm text-gray-300">© {currentYear} ZAZA COMMUNITY. All rights reserved.</p>
          <div className="flex justify-center space-x-4 mt-2">
            <a href="#" className="text-[#00ffff] hover:underline text-sm">Privacy Policy</a>
            <a href="#" className="text-[#00ffff] hover:underline text-sm">Terms & Conditions</a>
          </div>
        </div>
      </div>
    </footer>
